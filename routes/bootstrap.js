    ...
    const [
      ...
      db.query(`
        ...
        trick_feed AS (
          ...
          WHERE ut.user_id IN (SELECT user_id FROM followed) AND (ut.status IN ('${STATUS.MASTERED}', '${STATUS.IN_PROGRESS}') OR COALESCE(ut.goofy_status, '${STATUS.TODO}') IN ('${STATUS.MASTERED}', '${STATUS.IN_PROGRESS}'))
        ),
        event_feed AS (
